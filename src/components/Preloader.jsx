...
<div
    ...
    >      
    <div>
        <p className="preload font-thin text-xl md:text-2xl overflow-hidden border border-b-2 border-t-0 border-l-0 border-r-0 border-black border-opacity-75">Welcome To Lezada Technology</p>
